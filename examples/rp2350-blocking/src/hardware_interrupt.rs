//! Hardware Interrupt (Data Ready) Example for ICM-20948 on Raspberry Pi Pico 2 (Blocking version)
//!
...
async fn main(_spawner: Spawner) {
    info!("Starting Data-Ready interrupt example (RP2350 blocking)...");
    ...
    imu.configure_accelerometer(accel_cfg).unwrap();
    ...
    imu.configure_gyroscope(gyro_cfg).unwrap();
