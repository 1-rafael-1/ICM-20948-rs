//! Sensor configuration presets example for ICM-20948 on Raspberry Pi Pico 2 (Blocking version)
//!
...
async fn main(_spawner: Spawner) {
    ...
    let _ = imu.configure_accelerometer(accel_config);
    let _ = imu.configure_gyroscope(gyro_config);
